...
if(is_post('register')){
	...
	if(!in_array(post_int('direction'), array(1,2,3,4))){
	...
	$query->change_db($sql_db);
	$subjects_ar = post_int('direction') == 1 ? array('math', 'literacy') : array('gskills');
	$subjects_ar = post_int('direction') == 3 ? array('rlego') : $subjects_ar;
	$subjects_ar = post_int('direction') == 4 ? array('individual') : $subjects_ar;
	if(post_int('direction') == 1) {// math, literacy
	...
	foreach ($subjects_ar as $subject){
		...
		if(post_int('direction') == 1 || post_int('direction') == 3 || post_int('direction') == 4) {// math, literacy
			$fields_class['grade'] = post_int($subject.'_grade');
			$fields_class['dayes_id'] = post_int($subject.'_dayes');
		}
		else if(post_int('direction') == 2) {// general skills
			$fields_class['grade'] = 12;
			$fields_class['dayes_id'] = 1;
		}
	...
	$query->change_db($sql_db_l);
	//if(post_int('direction') == 1) {// math, literacy
		$math->generate_package_center($child_id, (float)post('_payment_period'), post_int('math_check'), post_int('literacy_check'), post_int('gskills_check'), post_int('rlego_check'), post_int('individual_check'));
	//}
	$query->change_db($sql_db);
