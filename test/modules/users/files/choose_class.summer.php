...
if(get('action') == "calculate_price"){
	...
	if($children_amount >= 15){
		...
		$payment_bh_lessons = get_int('rlego') == 1 ? 195 : 220; // 15-is mere 220 egireba
...
if(get('action') == "generate_hours"){
	...
	$hours = select_items("center_lesson_hours", "id", "lesson_time", "id IN (".implode(",", $dayes).") ORDER BY lesson_time ASC");
...
$replace_fields['direction_3'] = input_form("direction", "single_radio", 3, 3);
