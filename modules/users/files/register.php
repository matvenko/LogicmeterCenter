...
//*** choose class
$edit_value['math_check'] = 1;
$edit_value['rlego_check'] = 0;
...
$replace_fields['_STAR_DESCRIPTION'] = _STAR_DESCRIPTION;
...
$children_birthdate_years = range(date("Y") - 3, date("Y") - 30);
...
$query_l->where_vars['current_time'] = current_time();
$tmpl_file = $query_l->record_exist("center_subjects", "only_local_reg <= '{{current_time}}' AND reg_start_date <= '{{current_time}}' AND reg_end_date >= '{{current_time}}'") ? "register" : "register_denied";
$out = $templates->gen_module_html($replace_fields, $tmpl_file);