...
$out .= "</tr>\n";
$out .= "<tr>\n";
$out .= "<td class=\"table_td1\">"._IMAGE." (Mobile)</td>\n";
$out .= "<td class=\"table_td1\">\n";
if(get_int('id') !== 0){
	if(is_file("upload/".$module."/gallery/portrait/".$main_picture['pic'])){
		$out .= "<img src=\"upload/".$module."/gallery/portrait/".$main_picture['pic']."\" height=\"40\">";
	}
	$out .= " "._PICTURE.": <input type=\"file\" name=\"pic_portrait\" size=\"20\"> \n";
}
else{
       $out .= " "._PICTURE.": <input type=\"file\" name=\"pic_portrait\" size=\"20\"> \n";
}
