...
if(is_post('add_topic_text')){
	...
	//***********************
    $pic_name = time();
	$pic = upload_image("upload/".$module."/gallery", "pic", $pic_name, 'none', $topic_conf['big_img_width'], $topic_conf['big_img_height'], $topic_conf['small_img_width'], $topic_conf['small_img_height']);
	$pic_portrait = upload_image("upload/".$module."/gallery/portrait", "pic_portrait", $pic_name, 'none', $topic_conf['big_img_width'], $topic_conf['big_img_height'], $topic_conf['small_img_width'], $topic_conf['small_img_height']);
	if($pic !== false){
		$pic_fields['pic'] = $pic;
		if(get_int('id') == 0){
            ...
            @unlink("upload/".$module."/gallery/portrait/".rawurldecode($row->pic));
            $pic_fields['pic'] = $pic;
